...
class CommandsHandler {
    ...
    public function handle() {
        ...
        file_put_contents('/var/www/feedman/shared/storage/logs/request.log', '====1=====', FILE_APPEND);
        ...
        file_put_contents('/var/www/feedman/shared/storage/logs/request.log', '====2=====', FILE_APPEND);
